...
if __name__ == '__main__':
	...
	generated_token, key = phone1.generate_token()
	...
	print(f'Verified normally: {device.verify_token(token)}')
	...
	# 	print("Checking time after the token validity period has passed." " Current Time is: ", time.time())
	#
	# 	token = int(input("Enter token: "))
	#
